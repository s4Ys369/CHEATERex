...
static const u8 optsRespStr[][16] = {
    { TEXT_OPT_R1 }, { TEXT_OPT_R2 }, { TEXT_OPT_R3 },
};
...
static struct Option optsCheats[] = {
    ...
    DEF_OPT_CHOICE(optsCheatsStr[5], &Cheats.Responsive, RespChoices),
    ...
    DEF_OPT_TOGGLE(optsCheatsStr[9], &Cheats.Hover),
    DEF_OPT_TOGGLE(optsCheatsStr[10], &Cheats.Moon),
    DEF_OPT_CHOICE(optsCheatsStr[11], &Cheats.Run, SpeedChoices),
    DEF_OPT_TOGGLE(optsCheatsStr[12], &Cheats.NDB),
    DEF_OPT_TOGGLE(optsCheatsStr[13], &Cheats.Jump),
    DEF_OPT_TOGGLE(optsCheatsStr[14], &Cheats.SPD),
    DEF_OPT_TOGGLE(optsCheatsStr[15], &Cheats.TPF),
    DEF_OPT_CHOICE(optsCheatsStr[16], &Cheats.JB, SeqChoices),
    DEF_OPT_TOGGLE(optsCheatsStr[17], &Cheats.JBC),
    DEF_OPT_TOGGLE(optsCheatsStr[18], &Cheats.QuikEnd),
    DEF_OPT_CHOICE(optsCheatsStr[19], &Cheats.Hurt, HurtCheatChoices),
    DEF_OPT_TOGGLE(optsCheatsStr[20], &Cheats.Cann),
    DEF_OPT_TOGGLE(optsCheatsStr[21], &Cheats.AutoWK),
    DEF_OPT_TOGGLE(optsCheatsStr[22], &Cheats.GetShell),
