...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 2, castle_geo_001858),
        ...
        OBJECT(/*model*/ MODEL_CAPTAIN_TOAD,                     /*pos*/  -977, 1203, 2569, /*angle*/ 0,   0, 0, /*behParam*/ DIALOG_076 << 24, /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_CAPTAIN_TOAD,                     /*pos*/ -1584, 2253, 7157, /*angle*/ 0, 136, 0, /*behParam*/ DIALOG_083 << 24, /*beh*/ bhvToadMessage),
    ...
    AREA(/*index*/ 3, castle_geo_001C10),
        ...
        OBJECT(/*model*/ MODEL_CAPTAIN_TOAD,                      /*pos*/  1787, -1381, -1957, /*angle*/ 0, 126, 0, /*behParam*/ DIALOG_082 << 24, /*beh*/ bhvToadMessage),
